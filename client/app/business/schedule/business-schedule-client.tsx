  ...
  return (
    <>
      <PageHeader
        wide
        title="Schedule"
        description="View your daily schedule and reservations"
        actions={
      ...
      <PageBody wide>
        <div className="flex flex-col lg:flex-row gap-10">
          ...
          */}
          <aside className="lg:w-72 shrink-0 space-y-6 lg:sticky lg:top-[calc(var(--workspace-header)+var(--page-header))] lg:self-start lg:max-h-[calc(100svh-var(--workspace-header)-var(--page-header)-var(--space-24))] lg:overflow-y-auto">
            <Calendar
              mode="single"
