...
export default function GuestProfileClient({ customerId, canManage, businessTimezone }: { customerId: string; canManage: boolean; businessTimezone: string }) {
  ...
  if (loading) return <div className="px-[clamp(16px,2.5vw,32px)] py-6 flex min-h-80 items-center justify-center text-sm text-muted-foreground"><Loader2 className="mr-2 size-4 animate-spin" /> Loading guest…</div>;
  ...
  return <div className="flex flex-col gap-6 px-[clamp(16px,2.5vw,32px)] py-6">
    ...
    <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_22rem]">
      <div className="space-y-6">
        <section className="rounded-xl border bg-card p-5"><div className="flex items-center justify-between gap-3"><h2 className="font-semibold">Guest details</h2>{/* Neutral. §08 names dietary notes as the case that does NOT
