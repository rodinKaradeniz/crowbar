...
interface CustomerProfileSettingsClientProps {
  userId: string;
  initialName: string;
  initialPhone: string;
...
export default function CustomerProfileSettingsClient({
  userId,
  initialName,
  initialPhone,
  initialAvatar,
}: CustomerProfileSettingsClientProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setIsSaving(true);
    try {
      await clientUpdateProfile({ name, phone, avatar });
        ...
        <form onSubmit={handleSubmit}>
          <FieldGroup>
            <FieldSet>
              ...
              <FieldDescription>
                This information is used for your reservations
              </FieldDescription>
              ...
              <Field>
                ...
                />
                <FieldDescription>
                  Businesses may contact you about your reservations
                </FieldDescription>
              </Field>
