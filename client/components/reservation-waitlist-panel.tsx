...
export function ReservationWaitlistPanel({
  ...
  return (
    ...
    <div>
      ...
      <Dialog open={createOpen} onOpenChange={setCreateOpen}><DialogContent className="overflow-y-auto sm:max-w-xl"><DialogHeader><DialogTitle>Add to waitlist</DialogTitle><DialogDescription>Record the guest&apos;s preferred venue-local time and how far later they can accept.</DialogDescription></DialogHeader>
