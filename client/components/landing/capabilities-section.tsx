 ...
 *
 * THE HEADING AND THE TWO ROWS ARE NOW THREE SIBLINGS, not one section with
 * two children. Each of the five numbered capabilities is a `.mkt-band` in its
 * own right — see the band note in `globals.css`. That is also what gives 01
 * and 02 their own anchors: they were the only two footer links in the
 * "Product" column that shared a destination, because #capabilities is the
 * pair's shared heading and not either row.
 */
export function CapabilitiesSection() {
  return (
    <>
      <section
        id="capabilities"
        className="mkt-anchor mkt-shell mkt-sec-cap-head"
      >
        <div className="settle flex flex-wrap items-end gap-6">
          ...
          <p className="mkt-body-sm flex-[0_1_340px] text-text-secondary">
            ...
            booking, its order, its stock draw and its total are the same
            record.
          </p>
        </div>
      </section>
      ...
      <div className="mkt-shell">
        ...
        <div className="flex flex-wrap items-stretch">
          <div className="mkt-pad settle min-w-[min(100%,230px)] flex-[1_1_240px] border border-border md:border-r-0 bg-paper-raised">
            <p className="type-label mb-3.5 text-text-faint">Step 1 · 21:04</p>
          ...
          <div className="mkt-pad settle-3 min-w-[min(100%,230px)] flex-[1_1_240px] border border-border md:border-l-0 bg-paper-raised">
            <p className="type-label mb-3.5 text-text-faint">Step 3 · 21:26</p>
