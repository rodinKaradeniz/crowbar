...
class ErrorCode:
    ...
    PUBLIC_RESERVATIONS_DISABLED = "PUBLIC_RESERVATIONS_DISABLED"
    SLOT_UNAVAILABLE = "SLOT_UNAVAILABLE"
    RESERVATION_NOT_RESCHEDULABLE = "RESERVATION_NOT_RESCHEDULABLE"
    AVAILABILITY_OVERRIDE_FORBIDDEN = "AVAILABILITY_OVERRIDE_FORBIDDEN"
    AVAILABILITY_OVERRIDE_INVALID = "AVAILABILITY_OVERRIDE_INVALID"
    # Modules
