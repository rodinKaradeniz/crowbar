...
if [[ "$DEMO" == "true" ]]; then
  ...
  echo ""
  echo "  One recorded evening you can work: book, seat, order,"
  echo "  send to the pass, settle, close. What you change is kept"
  echo "  in your browser's cookie and nowhere else, and no guest"
  echo "  is ever contacted."
  echo ""
