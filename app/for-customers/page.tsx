          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="flex items-start gap-4 p-6 rounded-lg border bg-card">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  ...
                  exclusive deals, and promotions from your favorite venues.
            ...
            <div className="flex items-start gap-4 p-6 rounded-lg border bg-card">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Access your reservation history, view venue details, and
        ...
        <div className="container mx-auto px-6 max-w-3xl">
          ...
          <Accordion type="single" collapsible className="w-full">
            ...
            <AccordionItem value="item-2">
              ...
              <AccordionContent>
                Simply visit a venue's reservation page, select your preferred
            ...
            <AccordionItem value="item-4">
              ...
              <AccordionContent>
                ...
                from venues you've booked with.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-5">
              ...
              <AccordionContent>
                ...
                number. This information helps venues contact you if needed and
