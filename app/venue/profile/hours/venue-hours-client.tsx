...
interface VenueHoursClientProps {
  venueId: string;
  initialVenue: Venue | undefined;
}

export default function VenueHoursClient({
  venueId,
  initialVenue,
}: VenueHoursClientProps) {
    ...
    <div className="page-container">
      <div className="page-header">
        ...
        <p className="page-description">
          Set your venue&apos;s opening and closing times
        </p>
      </div>
