...
import { getCustomerDashboardStats, getVenueById, getTableById } from "@/mock-data";
...
export default function CustomerOverviewClient({
  ...
  const stats = useMemo(() => getCustomerDashboardStats(customerId), [customerId]);
  ...
  return (
    <div className="p-6 h-[calc(100vh-3rem)] flex flex-col gap-4">
      ...
      <div>
        ...
        <p className="text-sm text-muted-foreground">Here&apos;s your reservation overview</p>
      </div>
        ...
        <Card className="flex flex-col">
          ...
          <CardContent className="flex-1 flex flex-col items-center justify-center">
            ...
            <p className="text-center text-sm text-muted-foreground mt-2">
              {stats.totalReservations} total reservations
            </p>
          </CardContent>
        </Card>
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-start justify-between">
                        <div>
                          <h3 className="font-medium">{venue?.name || "Venue"}</h3>
