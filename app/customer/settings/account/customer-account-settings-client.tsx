...
interface CustomerAccountSettingsClientProps {
  userId: string;
  userEmail: string;
}
...
export default function CustomerAccountSettingsClient({
  userId,
  userEmail,
}: CustomerAccountSettingsClientProps) {
  // Email change state
  ...
  return (
    <div className="page-container">
      ...
      <form onSubmit={handleEmailChange}>
        ...
        <FieldGroup>
          <FieldSet>
            ...
            <Field>
              <FieldLabel htmlFor="emailPassword">Confirm with Password</FieldLabel>
              <Input
                id="emailPassword"
                type="password"
                value={emailPassword}
      ...
      <form onSubmit={handlePasswordChange}>
        <input type="password" name="dummy-pw" autoComplete="current-password" className="hidden" aria-hidden="true" />
