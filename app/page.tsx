...
import { VenuesCarouselSection } from "@/components/venues-carousel-section";
      ...
      <section className="relative h-svh flex items-center overflow-hidden">
        ...
        <div className="relative z-10 size-full">
          ...
          <div className="absolute top-[40%] right-[10%] flex flex-col items-end text-right">
            <p className="text-lg text-white mb-8 max-w-xl">
              The all-in-one platform for venues and customers to manage
      ...
      <section className="flex min-h-[80vh] w-full">
        ...
        <div className="flex w-full flex-col gap-4 p-6 md:w-1/2 md:p-10 lg:p-16 items-center justify-center">
          <div className="w-full max-w-md">
            <h2 className="page-title-lg mb-4">Powerful Tools for Venues</h2>
            ...
            <div className="mt-8">
              <Button asChild variant="outline" size="lg">
                <Link href="/for-venues" className="flex items-center gap-2">
      ...
      <section className="py-16 md:py-24 bg-muted/30">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center mb-12">
            <h2 className="page-title-lg mb-4">Our Partner Venues</h2>
            <p className="text-lg text-muted-foreground">
              Discover amazing venues that trust us with their reservations.
              From cozy bars to upscale lounges, find the perfect spot for your
              next visit.
            </p>
          </div>
          <VenuesCarouselSection venues={mockVenues} />
        </div>
      </section>
        ...
        <div className="container mx-auto px-6 py-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                We connect venues and customers through an intuitive platform
